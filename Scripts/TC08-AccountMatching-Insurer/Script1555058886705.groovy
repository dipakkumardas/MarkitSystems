...
WebUI.selectOptionByLabel(findTestObject('TC04-AccountMatching-MGA/EntityType'), 'Insurer', false)

WebUI.delay(5)

WebUI.selectOptionByLabel(findTestObject('TC04-AccountMatching-MGA/Entity'), 'New Insurer', false)
...
WebUI.selectOptionByLabel(findTestObject('TC04-AccountMatching-MGA/SelectAccount'), 'New Insurer Comission Account -- Allocated -- New Insurer-COM-ACC -- USD', 
    false)
